      ...
      <View className="rounded-t-3xl -mt-12 bg-white relative">
        ...
        >
          <View
            ...
            styel={{ backgroundColor: "rgba(255,255,255,0.4" }}
          >
            <Image
              className="h-16 w-16 rounded-full"
              source={require("../assets/images/single-person.png")}
            />
          </View>
          <View className="flex-1 ml-3">
            <Text className="text-lg font-bold text-white">Liva Pulat</Text>
